                                    ...
                                    <div class="row row-cols-lg-4 row-cols-md-3 row-cols-2 mb--n30">
                                        ...
                                        <form action="/cart/addToCart" method="post">
                                            ...
                                            <input type="hidden" name="product_id"
                                                value="<?php echo $productDetail['id']; ?>">
                                                ...
                                                <div class="product__items ">
                                                    <div class="product__items--thumbnail">
                                                        <a class="product__items--link"
                                                            href="/san-pham?id=<?php echo $product['id']; ?>">
                                                            <img class="product__items--img product__primary--img"
                                                                src="public/uploads/<?php echo $product['image']; ?>"
                                                                alt="product-img">
                                                        </a>
                                                    </div>
                                                    <div class="product__items--content">
                                                        <h3 class="product__items--content__title h4"><a
                                                                href="/san-pham?id=<?php echo $product['id']; ?>"><?php echo $product["name"] ?></a>
                                                        </h3>
                                                        <div class="product__items--price">
                                                            <span
                                                                class="current__price">$<?php echo number_format($product["price"]) ?></span>
