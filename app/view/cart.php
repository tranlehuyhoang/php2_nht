<main class="main__content_wrapper">
    ...
    // Kiểm tra xem yêu cầu có phải là yêu cầu cập nhật giỏ hàng không
    ...
    <section class="cart__section section--padding">
        <div class="container-fluid">
            <div class="cart__section--inner">
                <a class="continue__shopping--link" href="/cua-hang">
                    << Continue shopping</a>
                                ...
                                <div class="col-lg-8">
                                    <div class="cart__table">
                                        <table class="cart__table--inner">
                                            ...
                                            <tbody class="cart__table--body body-table-product">
                                                <?php if (isset($_GET['cleared'])) : ?>
                                                    <div class="cart__success-message">Cart has been cleared successfully!
                                                    </div>
                                                <?php endif; ?>
                                                        ...
                                                        <tr class="cart__table--body__items">
                                                            ...
                                                            <td class="cart__table--body__list">
                                                                <div class="quantity__box">
                                                                    ...
                                                                    <label>
                                                                        <input type="number" class="quantity__number quickview__value--number" name="quantity[<?php echo $productId; ?>]" value="<?php echo (int)$cartItem[1]; ?>" data-counter />
                                                                    </label>
                                        ...
                                        <div class="continue__shopping d-flex justify-content-between">
                                            <a href="/clear-cart" class="cart__summary--footer__btn primary__btn">Clear
                                                Cart</a>
