                                ...
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items">
                                        <a class="product__media--preview__items--link glightbox"
                                            ...
                                            href="public/uploads/<?php echo $productDetail['image']; ?>">
                                            <img class="product__media--preview__items--img"
                                                src="public/uploads/<?php echo $productDetail['image']; ?>"
                    ...
                    <div class="product__details--info">
                        <form action="/addtocart" method="post" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="product_quantity" id="product_quantity"
                                value="<?php echo $productDetail['quantity']; ?>">

                            <h2 class="product__details--info__title mb-15"><?php echo $productDetail['name']; ?></h2>
                            <div class="product__details--info__price mb-10">
                                <span
                                    class="current__price">$<?php echo number_format($productDetail['price']); ?></span>
                            </div>
                                    ...
                                    <div class="quantity__box">
                                        ...
                                        <label>
                                            <input type="number" name="product_quantity"
                                                class="quantity__number quickview__value--number" value="1" data-counter
                                                min="1" max="100" />
                                        </label>
                                        <button type="button"
                            ...
                            <div id="description" class="tab_pane active show">
                                <div class="product__tab--content">
                                    <div class="product__tab--content__step mb-30">
                                        <p class="product__tab--content__desc"><?php echo $productDetail['long_desc'] ?>
                                        </p>
                                    </div>
                                </div>
                            </div>
